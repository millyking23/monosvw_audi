...
export default function BeforeAfter({
  embedded = false,
  beforeSrc = "/images/completed-project.jpg",
  afterSrc = "/images/customer-dmax.jpg",
  title = "Isuzu Before & After",
  ariaLabel = "Drag to compare before and after bodywork",
}) {
  ...
  const comparison = (
    ...
    >
      <div className="absolute inset-0 bg-cover bg-center" style={{ backgroundImage: `url('${beforeSrc}')` }} aria-hidden="true" />
      <div className="absolute inset-0 overflow-hidden" style={{ clipPath: `inset(0 ${100 - position}% 0 0)` }} aria-hidden="true">
        <div className="absolute inset-0 bg-cover bg-center" style={{ backgroundImage: `url('${afterSrc}')` }} />
      </div>
